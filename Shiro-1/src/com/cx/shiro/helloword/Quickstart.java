package com.cx.shiro.helloword;
    ...
    public static void main(String[] args) {
        ...
        if (!currentUser.isAuthenticated()) {
            ...
            try {
                ...
                return;
                //若账户存在，但密码不匹配，则Shiro会抛出IncorrectCredentialsException异常
        ...
        //test a role:
        //测试是否有某一个角色,调用的Subject的#hasRole()方法
        ...
        //测试该用户是否具备某一个行为。调用的Subject的#isPermitted()方法
